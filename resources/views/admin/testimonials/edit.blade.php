...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-12 row align-items-center">
            <h2 class="h5 page-title col">{{ __('keywords.edit_testimonial') }}</h2>
            <x-alert type="success" />
            <!-- Create Form -->
            <form class="col-md-12 my-4" method="POST"
                action="{{ route('admin.testimonials.update', ['testimonial' => $testimonial]) }}"
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="name" name="name"
                            placeholder="{{ __('keywords.name') }}" value="{{ $testimonial->name ?? old('name') }}">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="position" name="position"
                            ...
                            value="{{ $testimonial->position ?? old('position') }}">
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                        ...
                        <textarea class="form-control" id="description" name="description"
                            rows="6">{{ $testimonial->description ?? old('description') }}</textarea>
