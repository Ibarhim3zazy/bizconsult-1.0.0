...
<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-12 row align-items-center">
            <h2 class="h5 page-title col">{{ __('keywords.edit_feature') }}</h2>
            <x-alert type="success" />
            <!-- Create Form -->
            <form class="col-md-12 my-4" method="POST"
                action="{{ route('admin.features.update', ['feature' => $feature]) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="title" name="title"
                            placeholder="{{ __('keywords.title') }}" value="{{ $feature->title ?? old('title') }}">
                        <x-validation-error field="title"></x-validation-error>
                    </div>
                    <div class="form-group col-md-6">
                        <x-form-label field="icon"></x-form-label>
                        <input type="text" class="form-control" id="icon" name="icon"
                            placeholder="{{ __('keywords.icon') }}" value="{{ $feature->icon ?? old('icon') }}">
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                        ...
                        <textarea class="form-control" id="description" name="description"
                            rows="6">{{ $feature->description ?? old('description') }}</textarea>
